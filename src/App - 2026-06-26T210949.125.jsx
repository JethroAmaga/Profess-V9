...
const CONVERSATION_CARDS = [
  { roleKey:"interviewer", gender:"f", name:"Marlene", roleEn:"Job Interview", roleId:"Wawancara Kerja",
    linesEn:[{speaker:"user",text:"Walk me through a time you disagreed with your manager."},{speaker:"char",text:"Take your time. I'm listening for how you handled it, not just the outcome."}],
    linesId:[{speaker:"user",text:"Coba ceritakan saat Anda tidak sependapat dengan atasan."},{speaker:"char",text:"Santai saja. Saya lebih ingin tahu caranya, bukan cuma hasilnya."}] },
  { roleKey:"negotiator", gender:"m", name:"Dorian", roleEn:"Negotiation", roleId:"Negosiasi",
    ...
    linesId:[{speaker:"user",text:"Harga bisa kami sesuaikan, tapi jadwal tidak bisa berubah."},{speaker:"char",text:"Kalau begitu, mari bahas berapa biaya kalau jadwalnya tetap maju."}] },
  { roleKey:"crush", gender:"f", name:"Talia", roleEn:"Romantic Tension", roleId:"Suasana Romantis",
    ...
    linesId:[{speaker:"user",text:"Jadi ini sebenarnya bukan soal kopi, kan?"},{speaker:"char",text:"Bukan. Aku cuma nggak punya alasan lain buat duduk di sini."}] },
  { roleKey:"colleague", gender:"m", name:"Reza", roleEn:"Workplace Talk", roleId:"Obrolan Kantor",
    linesEn:[{speaker:"user",text:"I think the deck needs another pass before the client sees it."},{speaker:"char",text:"Agreed. Slide six is where people usually get lost."}],
  ...
  { roleKey:"customer_service", gender:"f", name:"Yuna", roleEn:"Customer Service", roleId:"Layanan Pelanggan",
    ...
    linesId:[{speaker:"user",text:"Ini sudah ketiga kalinya saya telepon soal tagihan yang sama."},{speaker:"char",text:"Saya lihat riwayatnya. Kali ini saya selesaikan langsung."}] },
  { roleKey:"examiner", gender:"m", name:"Halvard", roleEn:"Thesis Defense", roleId:"Sidang Skripsi",
    linesEn:[{speaker:"user",text:"Can you defend your choice of sample size in chapter three?"},{speaker:"char",text:"Yes. I ran a power analysis before collecting any data."}],
    linesId:[{speaker:"user",text:"Bisa jelaskan alasan ukuran sampel di bab tiga?"},{speaker:"char",text:"Bisa. Saya hitung power analysis dulu sebelum ambil data."}] },
  { roleKey:"journalist", gender:"f", name:"Carmen", roleEn:"Press Question", roleId:"Wawancara Pers",
    linesEn:[{speaker:"user",text:"Off the record, were you surprised by the result?"},{speaker:"char",text:"Off the record, a little. On the record, we expected this."}],
    linesId:[{speaker:"user",text:"Di luar rekaman, apakah Anda kaget dengan hasilnya?"},{speaker:"char",text:"Di luar rekaman, sedikit. Tapi resminya, kami sudah menduga."}] },
  { roleKey:"blind_date", gender:"m", name:"Felix", roleEn:"First Date", roleId:"Kencan Pertama",
    ...
    linesId:[{speaker:"user",text:"Jujur, aku buka profil kamu tiga kali sebelum malam ini."},{speaker:"char",text:"Cuma tiga kali? Aku malah cek tiap hari minggu ini."}] },
  { roleKey:"parent", gender:"f", name:"Wening", roleEn:"Family Conversation", roleId:"Obrolan Keluarga",
    linesEn:[{speaker:"user",text:"I already accepted the offer. I'm telling you, not asking."},{speaker:"char",text:"Then tell me why, because right now I only hear the decision."}],
  ...
  { roleKey:"mentor", gender:"m", name:"Oskar", roleEn:"Mentorship", roleId:"Bimbingan",
    ...
    linesId:[{speaker:"user",text:"Aku terus menulis ulang paragraf yang sama dan nggak maju."},{speaker:"char",text:"Berhenti menulis ulang. Coba baca keras-keras, dengar apa yang hilang."}] },
  { roleKey:"judge", gender:"f", name:"Iverna", roleEn:"Mock Trial", roleId:"Sidang Tiruan",
    ...
    linesId:[{speaker:"user",text:"Keberatan, Yang Mulia. Saksi menebak-nebak niat terdakwa."},{speaker:"char",text:"Diterima. Tolong susun ulang pertanyaannya."}] },
  { roleKey:"ceo", gender:"m", name:"Bram", roleEn:"Investor Pitch", roleId:"Presentasi Investor",
    linesEn:[{speaker:"user",text:"Give me the version of this pitch that fits in two minutes."},{speaker:"char",text:"We cut delivery time by forty percent. Everything else is detail."}],
    linesId:[{speaker:"user",text:"Beri saya versi presentasi ini yang cukup dua menit."},{speaker:"char",text:"Kami pangkas waktu pengiriman empat puluh persen. Sisanya detail."}] },
  { roleKey:"vendor", gender:"f", name:"Pratiwi", roleEn:"Vendor Negotiation", roleId:"Negosiasi Vendor",
    linesEn:[{speaker:"user",text:"We need the materials by the fifteenth, not the twentieth."},{speaker:"char",text:"The fifteenth means I pull a team off another job. Tell me it's worth it."}],
  ...
  { roleKey:"dosen_pembimbing", gender:"m", name:"Sutanto", roleEn:"Thesis Advisor", roleId:"Dosen Pembimbing",
    linesEn:[{speaker:"user",text:"I think my hypothesis needs to change after this data."},{speaker:"char",text:"Good. That means you read the data instead of forcing it to agree with you."}],
  ...
  { roleKey:"calon_mertua", gender:"f", name:"Ratnasari", roleEn:"Partner's Parent", roleId:"Calon Mertua",
    linesEn:[{speaker:"user",text:"I want you to know I take your daughter's future seriously."},{speaker:"char",text:"Words are easy. Show me through how you treat her when things go wrong."}],
  ...
  { roleKey:"pak_rt", gender:"m", name:"Slamet", roleEn:"Neighborhood Head", roleId:"Pak RT",
    linesEn:[{speaker:"user",text:"I'd like to register the event for Saturday night, just so the street knows."},{speaker:"char",text:"Saturday's fine, just keep it down after ten. We have early risers here."}],
...
// Profess.
function ConversationMarquee({ lang, isMobile }) {
  ...
  const columns = Array.from({ length: 4 }, (_, colIndex) => cards.slice(colIndex * chunkSize, colIndex * chunkSize + chunkSize));
  const scale = isMobile ? 0.3 : 0.46;

  return (
    <div style={{ position:"relative", height: isMobile ? "380px" : "560px", overflow:"hidden", background:"#060606" }}>
      <div style={{ position:"absolute", inset:0, display:"flex", justifyContent:"center", alignItems:"center" }}>
        <div style={{ width:"1500px", height:"1500px", flexShrink:0, transform:`scale(${scale})` }}>
          <div style={{ transform:"rotateX(55deg) rotateY(0deg) rotateZ(-45deg)", transformStyle:"preserve-3d", position:"relative", top:"360px", right:"50%", display:"grid", gridTemplateColumns:"repeat(4, 1fr)", gap:"32px", width:"100%", height:"100%" }}>
            {columns.map((col, colIndex) => (
              ...
              >
                {col.map((card, i) => (
                  <div key={i} style={{ width:"280px", flexShrink:0, background:"#0E0C09", border:"1px solid #2A2520", borderRadius:"10px", padding:"18px 20px" }}>
                    <div style={{ display:"flex", gap:"12px", alignItems:"flex-end", marginBottom:"10px" }}>
                      ...
                      <div>
                        ...
                        <p style={{ fontSize:"9px", letterSpacing:".08em", textTransform:"uppercase", color:"#8A8478", margin:0 }}>{lang === "id" ? card.roleId : card.roleEn}</p>
                      </div>
                    </div>
                    <div style={{ fontSize:"11px", lineHeight:1.6 }}>
                      {(lang === "id" ? card.linesId : card.linesEn).map((l, li) => (
                        <p key={li} style={{ margin:"0 0 4px", color: l.speaker === "char" ? "#C8A458" : "#C8C4BC" }}>
                          <span style={{ opacity:0.6 }}>{l.speaker === "char" ? card.name + ":" : (lang === "id" ? "Anda:" : "You:")}</span> {l.text}
                        </p>
                      ))}
                    </div>
                  </div>
      ...
      >
        ...
        <ScrollRevealSection isMobile={isMobile}>
          <div style={{ padding: isMobile ? "32px 0 0" : "48px 0 0", background:"#060606", borderTop:"1px solid #141414" }}>
            ...
            <ConversationMarquee lang={lang} isMobile={isMobile}/>
          </div>
        </ScrollRevealSection>
