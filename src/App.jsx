...
export default function Profess() {
  ...
  const landingScrollThumbDrag = (downEvent) => {
    ...
    const move = (e) => {
      ...
      const thumbH = Math.max(36, (el.clientHeight / el.scrollHeight) * trackH);
      ...
      <div ref={landingScrollRef} className="screen-enter" style={{ ...BASE, overflowY:"auto", filter:warmMode?"sepia(0.18) saturate(1.2) brightness(1.02)":"none", transition:"filter 1.2s ease" }}>
        ...
        {landingScrollThumb.h > 0 && (
          <div
            ...
            style={{ position:"fixed", top:0, right:"2px", bottom:0, width:"10px", zIndex:1000, pointerEvents:"auto", cursor:"pointer" }}
          >
            <div
              onMouseDown={landingScrollThumbDrag}
              onTouchStart={landingScrollThumbDrag}
              style={{ position:"absolute", top: landingScrollThumb.top, left:"2px", width:"6px", height: landingScrollThumb.h, borderRadius:"3px", background:"rgba(200,168,112,0.55)", cursor:"grab" }}
            />
          </div>
        )}
        {introOverlay}
