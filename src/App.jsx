...
// ─── Main component ────────────────────────────────────────────────────────
// ─── WorldMap (adapted from Aceternity UI — no Tailwind/next-themes in this
// project, so theme is fixed dark to match the app, and styling is inline). ──
function WorldMap({ dots = [], lineColor = "#C8A870" }) {
  ...
  return (
    <div style={{ width:"100%", aspectRatio:"2/1", position:"relative", fontFamily:"'Manrope',sans-serif" }}>
      <img
        src={`data:image/svg+xml;utf8,${encodeURIComponent(svgMap)}`}
        style={{ height:"100%", width:"100%", maskImage:"linear-gradient(to bottom, transparent, white 10%, white 90%, transparent)", WebkitMaskImage:"linear-gradient(to bottom, transparent, white 10%, white 90%, transparent)", pointerEvents:"none", userSelect:"none", display:"block" }}
        alt="world map" height="495" width="1056" draggable={false} />
      <svg viewBox="0 0 800 400" style={{ width:"100%", height:"100%", position:"absolute", inset:0, pointerEvents:"none", userSelect:"none" }}>
        {dots.map((dot, i) => {
          ...
          return (
            <g key={`path-group-${i}`}>
              <motion.path
                ...
                fill="none" stroke="url(#path-gradient)" strokeWidth="1"
...
export default function Profess() {
  ...
  // Desktop only; panels have no hover affordance worth tilting on touch.
  ...
  if (screen === "landing") {
    ...
    const livingRoomMale = buildSVG(sofaLeft, agitated.roomMale ? "uncomfortable" : roomMood, false, "livingroom");
    const livingRoomFemale = buildSVG(sofaRight, agitated.roomFemale ? "uncomfortable" : roomMood, false, "livingroom");
            ...
            <svg viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice" style={{ width:"100%", height:"100%" }}>
              ...
              <foreignObject x="2" y="38" width="36" height="40" overflow="visible" opacity={warmMode ? 0.75 : 0.45}>
                <div xmlns="http://www.w3.org/1999/xhtml" style={{ width:"100%", height:"100%", perspective:"900px" }}>
                  <div style={{ width:"100%", height:"100%", animation:"friendBob 3.2s ease-in-out infinite", transformStyle:"preserve-3d", transition:"transform .2s ease-linear" }} onMouseMove={bodyTiltMove("roomMale")} onMouseLeave={bodyTiltLeave("roomMale")} dangerouslySetInnerHTML={{ __html: livingRoomMale }}/>
                </div>
              </foreignObject>
              ...
              <foreignObject x="62" y="38" width="34" height="38" overflow="visible" opacity={warmMode ? 0.75 : 0.45}>
                <div xmlns="http://www.w3.org/1999/xhtml" style={{ width:"100%", height:"100%", perspective:"900px" }}>
                  <div style={{ width:"100%", height:"100%", animation:"friendBob 2.8s ease-in-out infinite", animationDelay:"0.4s", transformStyle:"preserve-3d", transition:"transform .2s ease-linear" }} onMouseMove={bodyTiltMove("roomFemale")} onMouseLeave={bodyTiltLeave("roomFemale")} dangerouslySetInnerHTML={{ __html: livingRoomFemale }}/>
                </div>
              </foreignObject>
              {/* Coffee table — top */}
...
>
  ...
  />
        ...
        <div style={{ padding:"56px 40px 40px", background:"#060606", borderTop:"1px solid #141414" }}>
...
>
  ...
  {heroRow.map((charObj, i) => {
    ...
    const svg = buildSVG(charObj, agitated["hero"+i] ? "uncomfortable" : "neutral", false, "role");
    ...
    <div className="screen-enter" style={{ ...BASE, display:"flex", height:"100vh", overflow:"hidden", position:"relative" }}>
      ...
      {[
        ...
        <button key={opt.code}
          ...
          style={{ flex:1, background:"#0E0D0B", border:"none", borderRight:idx===0?"1px solid #141414":"none", color:"#E9E5DC", fontFamily:"inherit", cursor:"pointer", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", position:"relative", padding:"40px", transition:"background .3s", overflow:"hidden" }}
  ...
  const charAnimBlock = (size) => {
    ...
    const w = size; const h = isLarge ? "354px" : "72px";
    const charEl = <div key={displayRole+currentMood} className="char-enter"
      ...
      style={{ width:"100%", height:"100%", opacity:isTransitioning?0:1, transition:"opacity .38s, transform .2s ease-linear", transformStyle:"preserve-3d", animation:talkAnim||moodAnim||idleAnim, filter:isSpeaking?`drop-shadow(0 0 ${isLarge?"18px":"8px"} ${charMeta.accent}40)`:"none", position:"relative", zIndex:1 }} dangerouslySetInnerHTML={{ __html:charSVG }}/>;
    if (!moodColor) return <div style={{ width:w, height:h, perspective:"900px" }}>{charEl}</div>;
    ...
    return (
      <div style={{ position:"relative", width:w, height:h, perspective:"900px" }}>
    ...
    <div style={{ ...BASE, display:"flex", flexDirection:"column" }}>
      ...
      {isMobile ? (
        <div style={{ flex:1, display:"flex", flexDirection:"column", overflow:"hidden" }}>
          {/* Mobile character strip — character centered, not constrained to a row;
              name/title sit below it in normal flow so they can never overlap it. */}
          <div style={{ background:isTransitioning?"#0E0D0B":charMeta.bg, transition:"background .4s ease", borderBottom:"1px solid #141414", padding:"14px 16px", display:"flex", flexDirection:"column", alignItems:"center", gap:"6px", flexShrink:0 }}>
            {charAnimBlock("78px")}
        ...
        <div style={{ flex:1, display:"flex", overflow:"hidden" }}>
          ...
          <div style={{ width:"340px", flexShrink:0, borderRight:"1px solid #141414", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"flex-start", background:isTransitioning?"#0E0D0B":`radial-gradient(ellipse at 50% 40%, ${charMeta.bg} 0%, #0E0D0B 75%)`, transition:"background .5s ease", position:"fixed", top:"56px", left:0, height:"calc(100vh - 56px)", overflow:"hidden auto", zIndex:10 }}>
            <div style={{ display:"flex", flexDirection:"column", alignItems:"center", gap:"16px", padding:"32px 16px 24px", paddingBottom:showPlayer?"232px":"24px", transition:"padding-bottom .25s ease", width:"100%" }}>
              {charAnimBlock("283px")}
              <div style={{ textAlign:"center", opacity:isTransitioning?0:1, transition:"opacity .38s", width:"100%", marginTop:"8px" }}>
