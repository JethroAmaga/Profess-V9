  ...
  const inputControls = (inputFs="15px", inputPad="12px 14px", btnSz="52px") => (
    <div style={{ display:"flex", flexDirection:"column", gap:"8px" }}>
      ...
      <div style={{ display:"flex", gap:"8px", alignItems:"flex-end" }}>
        ...
        <div style={{ display:"flex", border:"1px solid #1A1A1A", height:btnSz, flexShrink:0 }}>
          <button onClick={askCoach} disabled={loading} title={lang==="id"?"Tanya Pelatih":"Ask Coach"}
            style={{ background:"none", border:"none", borderRight:"1px solid #1A1A1A", color:"#C8A458", width:btnSz, height:"100%", display:"flex", alignItems:"center", justifyContent:"center", cursor:loading?"default":"pointer", opacity:loading?0.4:1, transition:"background .2s, color .2s" }}
          ...
          <button onClick={toggleMic} className={isListening?"mic-active":""}
            style={{ background:isListening?"#180C0C":"none", border:"none", borderRight:"1px solid #1A1A1A", color:isListening?"#BC7A7A":"#C8A458", width:btnSz, height:"100%", display:"flex", alignItems:"center", justifyContent:"center", transition:"all .2s" }}
          ...
          <button id="psend" onClick={sendMessage} disabled={loading||!input.trim()}
            style={{ background:"none", border:"none", borderRight:"1px solid #1A1A1A", color:input.trim()&&!loading?sessionAccent:"#2A2A2A", width:btnSz, height:"100%", display:"flex", alignItems:"center", justifyContent:"center", transition:"all .2s", opacity:loading||!input.trim()?0.3:1 }}
          ...
          <button onClick={endSession} title={lang==="id"?"Akhiri sesi":"End session"}
            style={{ background:"none", border:"none", color:"#C8A458", width:btnSz, height:"100%", display:"flex", alignItems:"center", justifyContent:"center", cursor:"pointer", transition:"background .2s, color .2s" }}
  ...
  return (
    <div style={{ ...BASE, display:"flex", flexDirection:"column" }}>
      ...
      <div style={{ padding:`0 ${isMobile?"16px":"32px"}`, height:isMobile?"48px":"56px", borderBottom:"1px solid #141414", display:"flex", alignItems:"center", gap:"16px", flexShrink:0 }}>
        <button onClick={() => setScreen("landing")} style={{ background:"none", border:"none", padding:0, cursor:"pointer", flexShrink:0 }}>
