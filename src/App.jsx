        ...
        <div className="hero-section" style={{ position:"relative", height:"100vh", display:"flex", flexDirection:"column", overflow:"hidden", paddingBottom:"0" }}>
          ...
          <div className="hero-living-room" style={{ position:"absolute", right:0, top:0, height:"100%", width:"45%", opacity: warmMode ? 0.55 : 0.35, transition:"opacity 1.2s ease", zIndex:1 }}>
            <svg viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice" style={{ width:"100%", height:"100%" }}>
              ...
              {/* Standing lamp — beside the left character, behind the table layer */}
              {warmMode && <circle cx="10" cy="58" r="11" fill="url(#lampGlow)" opacity="0.45"/>}
              <ellipse cx="10" cy="75.3" rx="3.2" ry="0.6" fill="#000" opacity="0.25"/>
              <rect x="9" y="55" width="2" height="19" rx="0.6" fill="url(#lampBaseGrad)"/>
              <polygon points="6,55 14,55 12.3,46 7.7,46" fill="url(#lampShadeGrad)" stroke="#4A3020" strokeWidth="0.3"/>
              <line x1="7.6" y1="54.3" x2="9.3" y2="46.6" stroke={warmMode ? "#F8D880" : "#5A4020"} strokeWidth="0.25" opacity="0.45"/>
              <circle cx="10" cy="45.2" r="0.6" fill="#A8854C"/>
              <rect x="7" y="73.6" width="6" height="1.2" rx="0.5" fill="#3E2C18"/>
          ...
          {/* Lamp hint text */}
          <div className="hero-lamp-hint" style={{ position:"absolute", right:"53%", top:"30%", pointerEvents:"none", zIndex:6, textAlign:"center", transition:"color 1.2s ease" }}>
          ...
          {/* Lamp click overlay */}
          <div className="hero-lamp-overlay" onClick={() => { setWarmMode(w => { const next = !w; setRoomMood(next ? "warm" : "neutral"); return next; }); }} title={warmMode ? "warm mode on" : "click the lamp"} style={{ position:"absolute", right:"45%", top:"35%", width:"12%", height:"32%", cursor:"pointer", zIndex:7 }}/>
    {/* Radio hint text */}
<div
  ...
  />
        ...
        <div className="hero-living-room-mobile" style={{ display:"none", width:"100%", height:"300px", overflow:"hidden", opacity: warmMode ? 0.7 : 0.55, transition:"opacity 1.2s ease" }}>
          <svg viewBox="0 0 100 100" preserveAspectRatio="xMidYMid meet" style={{ width:"100%", height:"100%" }}>
            ...
            <text x="10" y="42" textAnchor="middle" fill="#C8B090" fontSize="2.2" opacity="0.8" letterSpacing="0.4" > {lang==="id" ? "CLICK THE LAMP" : "CLICK THE LAMP"} </text>
            {warmMode && <circle cx="10" cy="58" r="11" fill="url(#lampGlowMobile)" opacity="0.45"/>}
            <ellipse cx="10" cy="75.3" rx="3.2" ry="0.6" fill="#000" opacity="0.25"/>
            <g onClick={() => { setWarmMode(w => { const next = !w; setRoomMood(next ? "warm" : "neutral"); return next; }); }} style={{ cursor:"pointer" }}>
              <rect x="9" y="55" width="2" height="19" rx="0.6" fill="url(#lampBaseGradMobile)"/>
              <polygon points="6,55 14,55 12.3,46 7.7,46" fill="url(#lampShadeGradMobile)" stroke="#4A3020" strokeWidth="0.3"/>
              <line x1="7.6" y1="54.3" x2="9.3" y2="46.6" stroke={warmMode ? "#F8D880" : "#5A4020"} strokeWidth="0.25" opacity="0.45"/>
              <circle cx="10" cy="45.2" r="0.6" fill="#A8854C"/>
              <rect x="7" y="73.6" width="6" height="1.2" rx="0.5" fill="#3E2C18"/>
              <rect x="2" y="40" width="18" height="36" fill="transparent"/>
            </g>
