...
function ConversationMarquee({ isMobile }) {
  ...
  const scale = isMobile ? 0.46 : 0.78;

  return (
    <div style={{ position:"relative", height: isMobile ? "560px" : "920px", overflow:"hidden", background:"#060606" }}>
      <div style={{ position:"absolute", top:"50%", left:"50%", width:"1500px", height:"1500px", marginLeft:"-750px", marginTop:"-750px", transform:`scale(${scale})` }}>
