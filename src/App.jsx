  ...
  const inputControls = (inputFs="15px", inputPad="12px 14px", btnSz="52px") => (
    <div style={{ display:"flex", flexDirection:"column", gap:"8px" }}>
      ...
      <div style={{ display:"flex", gap:"8px", alignItems:"flex-end" }}>
        ...
        <div style={{ display:"flex", flexWrap:isMobile?"wrap":"nowrap", border:"1px solid #1A1A1A", width:isMobile?`calc(${btnSz} * 2)`:"auto", height:isMobile?`calc(${btnSz} * 2)`:btnSz, flexShrink:0, boxSizing:"border-box" }}>
