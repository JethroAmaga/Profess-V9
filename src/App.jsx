...
const CONVERSATION_CARDS = [
  ...
  { roleKey:"client", gender:"m", name:"Desmond", locale:"en", roleEn:"Client Expectations",
    linesEn:[{speaker:"user",text:"The mockups are nice, but I need to see this work on mobile."},{speaker:"char",text:"Mobile's next in the queue. Give me until Thursday."}] },
  ...
  { roleKey:"auditor", gender:"m", name:"Conrad", locale:"en", roleEn:"Compliance Review",
    linesEn:[{speaker:"user",text:"These numbers don't match what you reported last quarter."},{speaker:"char",text:"They shouldn't. We restated them in March, I can show you the filing."}] },
  { roleKey:"defense_lawyer", gender:"m", name:"Hendra", locale:"id", roleId:"Pengacara Pembela",
    linesId:[{speaker:"user",text:"Klien saya tidak berada di lokasi saat kejadian terjadi."},{speaker:"char",text:"Buktikan itu dengan alibi, bukan cuma keterangan klien sendiri."}] },
...
function ConversationMarquee({ isMobile }) {
  ...
  return (
    <div style={{ position:"relative", height: isMobile ? "640px" : "1040px", overflow:"hidden", background:"#060606" }}>
      <div style={{ position:"absolute", top:"50%", left:"50%", width:"1500px", height:"1500px", marginLeft:"-480px", marginTop:"-750px", transform:`scale(${scale})` }}>
        <div style={{ transform:"rotateX(55deg) rotateY(0deg) rotateZ(-45deg)", transformStyle:"preserve-3d", width:"100%", height:"100%", display:"grid", gridTemplateColumns:"repeat(4, 1fr)", gap:"32px" }}>
