            ...
            <svg viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice" style={{ width:"100%", height:"100%" }}>
              ...
              <foreignObject x="2" y="38" width="36" height="40" overflow="visible" opacity={warmMode ? 0.75 : 0.45}>
                <div xmlns="http://www.w3.org/1999/xhtml" style={{ width:"100%", height:"100%", perspective:"900px" }}>
                  <div style={{ width:"100%", height:"100%", transformStyle:"preserve-3d", transition:"transform .2s ease-linear" }} onMouseMove={bodyTiltMove("roomMale")} onMouseLeave={bodyTiltLeave("roomMale")}>
              ...
              <foreignObject x="62" y="38" width="34" height="38" overflow="visible" opacity={warmMode ? 0.75 : 0.45}>
                <div xmlns="http://www.w3.org/1999/xhtml" style={{ width:"100%", height:"100%", perspective:"900px" }}>
                  <div style={{ width:"100%", height:"100%", transformStyle:"preserve-3d", transition:"transform .2s ease-linear" }} onMouseMove={bodyTiltMove("roomFemale")} onMouseLeave={bodyTiltLeave("roomFemale")}>
    ...
    <div style={{ ...BASE, display:"flex", flexDirection:"column" }}>
      ...
      {isMobile ? (
        <div style={{ flex:1, display:"flex", flexDirection:"column", overflow:"hidden" }}>
          ...
          <div style={{ background:isTransitioning?"#0E0D0B":charMeta.bg, transition:"background .4s ease", borderBottom:"1px solid #141414", padding:"14px 16px", display:"flex", flexDirection:"row", alignItems:"center", justifyContent:"center", gap:"12px", flexShrink:0 }}>
            <div style={{ textAlign:"right", maxWidth:"34%", flexShrink:0 }}>
