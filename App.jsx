...
function buildSVG(charOrKey, mood, isTalking, scene = "role") {
  ...
  const hairStyles = {
    long: `<ellipse cx="80" cy="46" rx="34" ry="20" fill="${h}"/>
...
`,
    soft_fringe: `
  <ellipse cx="80" cy="46" rx="34" ry="18" fill="${h}"/>
  <rect x="46" y="46" width="68" height="18" fill="${h}"/>
...
`,
  ...
  />
`,
    faux: `<ellipse cx="80" cy="46" rx="34" ry="19" fill="${h}"/>
       <rect x="46" y="46" width="68" height="22" fill="${h}"/>
       <ellipse cx="47" cy="72" rx="10" ry="18" fill="${h}"/>
       <ellipse cx="113" cy="72" rx="10" ry="18" fill="${h}"/>`,
    short: `<ellipse cx="80" cy="47" rx="33" ry="18" fill="${h}"/>
       <rect x="47" y="47" width="66" height="22" fill="${h}"/>`,
    buzz: `<ellipse cx="80" cy="48" rx="31" ry="14" fill="${h}"/>
       <rect x="49" y="48" width="62" height="14" fill="${h}"/>`,
    quiff: `<ellipse cx="80" cy="48" rx="32" ry="15" fill="${h}"/>
       <rect x="48" y="48" width="64" height="18" fill="${h}"/>
       <path d="M62 34 Q80 18 98 34 Q86 28 80 30 Q74 28 62 34Z" fill="${h}"/>`,
    messy: `<ellipse cx="80" cy="47" rx="33" ry="17" fill="${h}"/>
       <rect x="47" y="47" width="66" height="20" fill="${h}"/>
       <path d="M50 38 L56 28 L60 40Z" fill="${h}"/>
       <path d="M72 32 L78 22 L82 33Z" fill="${h}"/>
       <path d="M96 38 L104 30 L100 42Z" fill="${h}"/>`,
  };
  ...
  const armLNoHand = `<ellipse cx="36" cy="136" rx="10" ry="8" fill="${b}"/>
    <rect x="26" y="132" rx="8" width="20" height="36" fill="${b}"/>
    <rect x="22" y="164" rx="6" width="18" height="28" fill="${b}"/>`;
  const armRBaseNoHand = `<ellipse cx="124" cy="136" rx="10" ry="8" fill="${b}"/>
    <rect x="114" y="132" rx="8" width="20" height="36" fill="${b}"/>
    <rect x="120" y="164" rx="6" width="18" height="28" fill="${b}"/>`;
  const handL = `<ellipse cx="30" cy="196" rx="11" ry="9" fill="${s}"/>`;
  const handR = `<ellipse cx="130" cy="196" rx="11" ry="9" fill="${s}"/>`;
  ...
  // Legs + feet — larger, visible below seated/standing characters
  const legsFeetSVG = `<rect x="54" y="204" width="14" height="20" rx="4" fill="${darken(b,12)}"/>
    <rect x="92" y="204" width="14" height="20" rx="4" fill="${darken(b,12)}"/>
...
export default function Profess() {
  ...
  if (screen === "landing") {
    ...
    const panelCharTerms = buildSVG(termsPanel, "serious", false);
    const panelCharBegin = buildSVG(beginPanel, "neutral", false);
    ...
    return (
      <>
      <div className="screen-enter" style={{ ...BASE, overflowY:"auto", filter:warmMode?"sepia(0.18) saturate(1.2) brightness(1.02)":"none", transition:"filter 1.2s ease" }}>
        <style>{css}</style>
    ...
    >
      {lang==="id" ? "Lanjutkan" : "Continue"}
        ...
        <div className="hero-section" style={{ position:"relative", height:"100vh", display:"flex", flexDirection:"column", overflow:"hidden", paddingBottom:"0" }}>
          ...
          <div className="hero-living-room" style={{ position:"absolute", right:0, top:0, height:"100%", width:"45%", opacity: warmMode ? 0.55 : 0.35, transition:"opacity 1.2s ease", pointerEvents:"none", zIndex:1 }}>
            <svg viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice" style={{ width:"100%", height:"100%" }}>
              ...
              {/* Radio body */}
              <rect x="79" y="66" width="13" height="8" rx="1" fill="#4A4A52" stroke="#5A5A62" strokeWidth="0.4"/>
              {/* Radio speaker grille */}
              <line x1="80.5" y1="67.5" x2="87" y2="67.5" stroke="#3A3A42" strokeWidth="0.45" opacity="0.9"/>
              <line x1="80.5" y1="69" x2="87" y2="69" stroke="#3A3A42" strokeWidth="0.45" opacity="0.9"/>
              <line x1="80.5" y1="70.5" x2="87" y2="70.5" stroke="#3A3A42" strokeWidth="0.45" opacity="0.9"/>
              {/* Radio knobs */}
              <circle cx="89" cy="68.2" r="1" fill="#6A6A72"/>
              <circle cx="89" cy="71" r="1" fill="#6A6A72"/>
              {/* Radio antenna */}
...
>
  ...
  />
        ...
        <div className="hero-living-room-mobile" style={{ display:"none", width:"100%", height:"220px", overflow:"hidden", opacity: warmMode ? 0.55 : 0.40, transition:"opacity 1.2s ease" }}>
          <svg viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice" style={{ width:"100%", height:"100%" }}>
            <defs>
            ...
            <line x1="0" y1="75" x2="100" y2="75" stroke="#2A2010" strokeWidth="0.3" opacity="0.7"/>
            <ellipse cx="50" cy="75.5" rx="35" ry="4" fill="#2A1A0A" opacity="0.4"/>
            <foreignObject x="2" y="38" width="36" height="40" overflow="visible">
              <div xmlns="http://www.w3.org/1999/xhtml" style={{ width:"100%", height:"100%", animation:"friendBob 3.2s ease-in-out infinite" }} dangerouslySetInnerHTML={{ __html: livingRoomMale }}/>
            </foreignObject>
          ...
          <p style={{ fontFamily:"'Inter',sans-serif", fontWeight:300, fontSize:"10px", letterSpacing:".1em", color:"#3A3530", textAlign:"center", padding:"8px 0 0" }}>
...
>
    ...
    return (
      ...
      >
        ...
        <div style={{ position:"relative", background:"#060606", backgroundImage:"radial-gradient(circle, #1C1C1C 1px, transparent 1px)", backgroundSize:"24px 24px", borderTop:"1px solid #141414" }}>
          {/* Panels row */}
          <div className="panels-row" style={{ display:"flex", borderBottom:"1px solid #141414" }}>
            {/* PANEL 1 — BEGIN */}
            <button className="panel-btn" onClick={() => setScreen("lang")}
              ...
              onMouseLeave={e=>{ e.currentTarget.style.background="#0A0A0A"; e.currentTarget.style.borderTopColor="transparent"; e.currentTarget.querySelector('.panel-char').style.opacity="0.85"; }}>
            ...
            {/* PANEL 2 — ABOUT */}
            <button className="panel-btn" onClick={() => setExpandedPanel(p => p==="about" ? null : "about")}
              ...
              onMouseEnter={e=>{ e.currentTarget.style.background="#0E0E0E"; e.currentTarget.style.borderTopColor="#C8A870"; e.currentTarget.querySelector('.panel-char').style.opacity="1"; }}
              onMouseLeave={e=>{ e.currentTarget.style.background=expandedPanel==="about"?"#0C0C0A":"#0A0A0A"; e.currentTarget.style.borderTopColor=expandedPanel==="about"?"#C8A870":"transparent"; e.currentTarget.querySelector('.panel-char').style.opacity="0.85"; }}>
              <div className="panel-char-box" style={{ position:"relative", width:"140px", marginBottom:"32px" }}>
            ...
            {/* PANEL 3 — TERMS */}
            <button className="panel-btn" onClick={() => setExpandedPanel(p => p==="terms" ? null : "terms")}
              ...
              onMouseEnter={e=>{ e.currentTarget.style.background="#0E0E0E"; e.currentTarget.style.borderTopColor="#C8A870"; e.currentTarget.querySelector('.panel-char').style.opacity="1"; }}
              onMouseLeave={e=>{ e.currentTarget.style.background=expandedPanel==="terms"?"#0C0C0A":"#0A0A0A"; e.currentTarget.style.borderTopColor=expandedPanel==="terms"?"#C8A870":"transparent"; e.currentTarget.querySelector('.panel-char').style.opacity="0.85"; }}>
  ...
  if (screen === "mode") return (
    <div className="screen-enter" style={{ ...BASE, display:"flex", height:"100vh", overflow:"hidden", position:"relative" }}>
      ...
      {[
        ...
        { key:"social", label:"S", name:lang==="id"?"Sosial":"Social", accent:"#C47A8A",
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:"0", border:"1px solid #141414" }}>
              {levels.map((lvl, idx) => (
                <button key={lvl.key}
                  ...
                  onMouseLeave={e=>{ e.currentTarget.style.background="#080808"; e.currentTarget.querySelector('.lvl-border').style.opacity="0"; e.currentTarget.querySelector('.lvl-bars').style.transform="scale(1)"; }}
                  style={{ background:"#080808", border:"none", borderBottom:idx<levels.length-1?"1px solid #141414":"none", color:"#F0EDE6", fontFamily:"inherit", padding:"0 24px", minHeight:"120px", cursor:"pointer", textAlign:"left", display:"flex", gap:"24px", alignItems:"center", position:"relative", overflow:"hidden", transition:"background .2s" }}>
        ...
        <div style={{ position:"relative", zIndex:1, flex:1, overflowY:"auto", padding:"40px" }}>
          <div style={{ maxWidth:"600px", margin:"0 auto" }}>
            ...
            <div style={{ marginBottom:"48px" }}>
              <button onClick={() => { setScenario(null); startSession(pendingMode, null); }}
                  ...
                  <div style={{ display:"flex", flexDirection:"column" }}>
                    {group.items.map((item, ii) => (
                      <button key={ii}
                        ...
                        onMouseEnter={e=>{ e.currentTarget.style.color="#F0EDE6"; e.currentTarget.style.paddingLeft="8px"; e.currentTarget.style.borderLeft=`2px solid ${accent}`; e.currentTarget.style.background=`${accent}07`; }}
  ...
  const charAnimBlock = (size) => {
    ...
    const moodColor = AURA_COLORS[currentMood];
    const w = size; const h = isLarge ? "250px" : "72px";
    const charEl = <div key={displayRole+currentMood} className="char-enter" style={{ width:"100%", height:"100%", opacity:isTransitioning?0:1, transition:"opacity .38s", animation:talkAnim||moodAnim||idleAnim, filter:isSpeaking?`drop-shadow(0 0 ${isLarge?"18px":"8px"} ${charMeta.accent}40)`:"none", position:"relative", zIndex:1 }} dangerouslySetInnerHTML={{ __html:charSVG }}/>;
    if (!moodColor) return <div style={{ width:w, height:h }}>{charEl}</div>;
  ...
  const inputControls = (inputFs="15px", inputPad="12px 14px", btnSz="52px") => (
    <div style={{ display:"flex", flexDirection:"column", gap:"8px" }}>
      {showMusicSuggest && !isMobile && (
        <button onClick={() => { hasOpenedMusic.current = true; setShowMusicSuggest(false); setActivePlaylist(sessionMode === "social" ? 1 : 0); setShowPlayer(true); }}
          ...
          onMouseEnter={e => e.currentTarget.style.color="#C8A458"}
      ...
      <div style={{ display:"flex", gap:"8px", alignItems:"flex-end" }}>
        <textarea ref={textareaRef}
          style={{ flex:1, background:"#0A0A0A", border:`1px solid ${isListening?"#7A4040":"#1A1A1A"}`, color:"#F0EDE6", fontFamily:"inherit", fontSize:inputFs, fontWeight:300, lineHeight:1.7, padding:inputPad, resize:"none", outline:"none", minHeight:btnSz, maxHeight:"150px", overflowY:"auto", transition:"border-color .2s" }}
        ...
        <button onClick={toggleMic} className={isListening?"mic-active":""}
          style={{ background:isListening?"#180C0C":"none", border:`1px solid ${isListening?"#7A4040":"#1A1A1A"}`, color:isListening?"#BC7A7A":"#C8A458", width:btnSz, height:btnSz, display:"flex", alignItems:"center", justifyContent:"center", flexShrink:0, transition:"all .2s" }}
          onMouseEnter={e=>{ if(!isListening){e.currentTarget.style.borderColor="#2A2520";e.currentTarget.style.color="#C8A458";} }}
          onMouseLeave={e=>{ if(!isListening){e.currentTarget.style.borderColor="#1A1A1A";e.currentTarget.style.color="#C8A458";} }}>
          {isListening ? <IconStop/> : <IconMic/>}
        </button>
        <button id="psend" onClick={sendMessage} disabled={loading||!input.trim()}
          style={{ background:"none", border:`1px solid ${input.trim()&&!loading?sessionAccent:"#1A1A1A"}`, color:input.trim()&&!loading?sessionAccent:"#2A2A2A", fontFamily:"inherit", fontSize:"11px", letterSpacing:".1em", textTransform:"uppercase", width:btnSz, height:btnSz, display:"flex", alignItems:"center", justifyContent:"center", flexShrink:0, transition:"all .2s", opacity:loading||!input.trim()?0.3:1 }}
          onMouseEnter={e=>{ if(input.trim()&&!loading){e.currentTarget.style.background=sessionAccent;e.currentTarget.style.color="#080808";} }}
  ...
  const actionRow = (compact=false) => (
    <div style={{ display:"flex", gap:"16px", alignItems:"center", marginBottom:compact?"6px":"8px" }}>
      ...
      <button onClick={endSession} style={{ background:"none", border:"none", color:"#C8A458", fontFamily:"inherit", fontSize:"10px", letterSpacing:".08em", textTransform:"uppercase", marginLeft:"auto", transition:"color .2s", padding:0 }}>
    ...
    <div style={{ ...BASE, display:"flex", flexDirection:"column" }}>
      ...
      {isMobile ? (
        <div style={{ flex:1, display:"flex", flexDirection:"column", overflow:"hidden" }}>
          ...
          <div style={{ padding:"8px 16px 16px", borderTop:"1px solid #141414", background:"#080808" }}>
            {actionRow(true)}
      ...
      <div style={{ padding:"6px 12px", display:"flex", gap:"5px", overflowX:"auto", scrollbarWidth:"none" }}>
        {PLAYLISTS.map((pl, i) => (
          <button key={i} onClick={() => setActivePlaylist(i)}
            style={{ padding:"3px 8px", border:`1px solid ${activePlaylist===i?"#C8A870":"#1E1E1E"}`, color:activePlaylist===i?"#C8A870":"#C8A458", fontFamily:"'Inter',sans-serif", fontWeight:300, fontSize:"9px", letterSpacing:".06em", background:"none", cursor:"pointer", flexShrink:0, transition:"border-color .2s, color .2s" }}>
            {pl.label}
          </button>
        ))}
      </div>
